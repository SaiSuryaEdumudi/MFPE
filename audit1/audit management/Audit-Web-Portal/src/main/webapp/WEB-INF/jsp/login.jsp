	...
	<style type="text/css">
		*{
		...
		.btn{
			...
			outline: none;
			border: none;
			background-image: linear-gradient(to bottom, #f2d5d3 0%, #cfbab8 100%);
			background-size: 200%;
			font-size: 1.2rem;
			color: 	#1f1c1d;
			font-family: 'Poppins', sans-serif;
...
<body>
<div class="heading">
	<h1 style="font-family:Garamond;"> Audit Management System</h1>
	</div>
	<img class="wave" src="/images/q7.jpg">
	<div class="container">
